...
export default { PORT, URI_DB, DB_NAME, SECRET, ALG, ACCESS_KEY_ID, SECRET_ACCESS_KEY, REGION, URL_BACKEND, ACCESS_TOKEN_MERCADOPAGO, PUBLIC_KEY_MERCADOPAGO, URL_API, SECRET_KEY_TICKETS};